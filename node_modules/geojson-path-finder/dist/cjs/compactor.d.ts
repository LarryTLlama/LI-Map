 ...
 * @returns
 */
export default function compactGraph<TEdgeData, TProperties>(vertices: Vertices, vertexCoords: Coordinates, edgeData: Record<Key, Record<Key, TEdgeData | undefined>>, options?: PathFinderOptions<TEdgeData, TProperties>): {
    graph: Vertices;
