  ...
  mouseWheel: function mouseWheel(e) {
    ...
    if (delta > 0) {
      if (this.zoomCount < this.clientZoom) {
        if (canvasZoomX < this.canvasPosition.deltaX || canvasZoomX > this.canvasPosition.deltaX + this.initialImageWidth || canvasZoomY < this.canvasPosition.deltaY || canvasZoomY > this.canvasPosition.deltaY + this.newImageHeight) {
          return false;
        }
...
var canvasEvents = {
  ...
  restrictArea: function restrictArea() {
    switch (this.zoomCount) {
      case 0:
      case 1:
      case -1:
      case -2:
        if (this.tmpCanvasPosX > this.initialImageWidth / this.zoom - this.initialImageWidth * 0.6 / this.zoom || this.tmpCanvasPosX < -(this.initialImageWidth - this.initialImageWidth * 0.2) || this.tmpCanvasPosY > this.newImageHeight / this.zoom - this.newImageHeight * 0.6 / this.zoom || this.tmpCanvasPosY < -(this.newImageHeight - this.newImageHeight * 0.2)) return false;
        break;
      case 2:
        if (this.tmpCanvasPosX > this.initialImageWidth / this.zoom - this.initialImageWidth * 0.65 / this.zoom || this.tmpCanvasPosX < -(this.initialImageWidth - this.initialImageWidth * 0.05) || this.tmpCanvasPosY > this.newImageHeight / this.zoom - this.newImageHeight * 0.65 / this.zoom || this.tmpCanvasPosY < -(this.newImageHeight - this.newImageHeight * 0.05)) return false;
        break;
